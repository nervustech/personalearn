...
**Status:** Superseded by [ADR-005](adr-005-eval-direct-multimodal.md) (2026-08-02). Do not implement further against this document.

**Status (historical):** Proposed (2026-07-26) — revises the 2026-07-19 ADR-004 stub with locked implementation decisions
